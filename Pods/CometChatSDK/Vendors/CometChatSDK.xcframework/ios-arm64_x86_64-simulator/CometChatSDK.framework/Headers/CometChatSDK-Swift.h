...
+ (BaseMessage * _Nonnull)updateMessageWithReactionInfoWithBaseMessage:(BaseMessage * _Nonnull)baseMessage messageReaction:(MessageReaction * _Nonnull)messageReaction action:(enum ReactionAction)action SWIFT_WARN_UNUSED_RESULT;
@end
...
+ (void)markAsDeliveredWithNotificationPayload:(NSDictionary * _Nullable)payload;
...
- (void)onInteractiveMessageReceived:(BaseMessage * _Nonnull)baseMessage;
...
- (void)onMessageReactionAddedWithMessageReaction:(MessageReaction * _Nonnull)messageReaction;
- (void)onMessageReactionRemovedWithMessageReaction:(MessageReaction * _Nonnull)messageReaction;
@end
...
SWIFT_CLASS("_TtC12CometChatSDK15MessageReaction")
@interface MessageReaction : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, copy) NSString * _Nonnull id;
@property (nonatomic) NSInteger messageId;
@property (nonatomic, copy) NSString * _Nonnull reaction;
@property (nonatomic, copy) NSString * _Nonnull uid;
@property (nonatomic) uint64_t reactedAt;
...
- (MessageRequestBuilder * _Nonnull)myMentionsOnly:(BOOL)myMentions SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC12CometChatSDK15ReactionRequest")
@interface ReactionRequest : NSObject
- (nonnull instancetype)init:(ReactionRequestBuilder * _Nonnull)builder OBJC_DESIGNATED_INITIALIZER;
/// <code>fetchPrevious</code> method is used to fetch previous message reactions.
///
/// returns:
/// This method does not return anything.
- (void)fetchPreviousOnSuccess:(void (^ _Nonnull)(NSArray<MessageReaction *> * _Nonnull))onSuccess onError:(void (^ _Nonnull)(CometChatException * _Nullable))onError;
/// <code>fetchNext</code> method is used to fetch next message reactions.
///
/// returns:
/// This method does not return anything.
- (void)fetchNextOnSuccess:(void (^ _Nonnull)(NSArray<MessageReaction *> * _Nonnull))onSuccess onError:(void (^ _Nonnull)(CometChatException * _Nullable))onError;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC12CometChatSDK22ReactionRequestBuilder")
@interface ReactionRequestBuilder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// <code>setLimit</code> method is used to set the limit for reactions.
///
/// returns:
/// <code>ReactionRequestBuilder</code> object.
- (ReactionRequestBuilder * _Nonnull)setLimitWithLimit:(NSInteger)limit SWIFT_WARN_UNUSED_RESULT;
/// <code>setMessageId</code> method is used to set the message id for reactions.
///
/// returns:
/// <code>ReactionRequestBuilder</code> object.
- (ReactionRequestBuilder * _Nonnull)setMessageIdWithMessageId:(NSInteger)messageId SWIFT_WARN_UNUSED_RESULT;
/// <code>setReaction</code> method is used to set the reaction for reactions.
/// <ul>
///   <li>
///     Parameters:
///   </li>
...
/// returns:
/// <code>ReactionRequestBuilder</code> object.
- (ReactionRequestBuilder * _Nonnull)setReactionWithReaction:(NSString * _Nonnull)reaction SWIFT_WARN_UNUSED_RESULT;
/// <code>build</code> method is used to create a new <code>ReactionRequest</code> object.
///
/// returns:
/// <code>ReactionRequest</code> object.
- (ReactionRequest * _Nonnull)build SWIFT_WARN_UNUSED_RESULT;
@end
